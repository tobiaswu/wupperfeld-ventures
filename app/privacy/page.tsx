...
export default function Privacy() {
  return (
    <main className="container mx-auto py-8 px-4 bg-gunmetal-400/20 backdrop-blur-sm rounded-xl shadow-lg text-steel-blue-200">
      ...
      <section aria-labelledby="log-files">
        <h2 id="log-files" className="pb-4 text-2xl text-buff-400">Log Files</h2>
      ...
      <section aria-labelledby="privacy-policies">
        <h2 id="privacy-policies" className="pb-4 text-2xl text-buff-400">Privacy Policies</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="third-party">
        <h2 id="third-party" className="pb-4 text-2xl text-buff-400">Third Party Privacy Policies</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="children">
        <h2 id="children" className="pb-4 text-2xl text-buff-400">Children&apos;s Information</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="online-policy">
        <h2 id="online-policy" className="pb-4 text-2xl text-buff-400">Online Privacy Policy Only</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="data-processing-location">
        <h2 id="data-processing-location" className="pb-4 text-2xl text-buff-400">Data Processing Location</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="privacy-rights">
        <h2 id="privacy-rights" className="pb-4 text-2xl text-buff-400">Your Privacy Rights</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="data-retention">
        <h2 id="data-retention" className="pb-4 text-2xl text-buff-400">Data Retention</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="data-processing-activities">
        <h2 id="data-processing-activities" className="pb-4 text-2xl text-buff-400">Data Processing Activities</h2>
      ...
      <section aria-labelledby="automated-decisions">
        <h2 id="automated-decisions" className="pb-4 text-2xl text-buff-400">Automated Decision Making</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="special-categories">
        <h2 id="special-categories" className="pb-4 text-2xl text-buff-400">Special Categories of Personal Data</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="changes">
        <h2 id="changes" className="pb-4 text-2xl text-buff-400">Changes to This Privacy Policy</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="contact">
        <h2 id="contact" className="pb-4 text-2xl text-buff-400">Contact Us About Privacy</h2>
        <p className="pb-8 text-steel-blue-600">
      ...
      <section aria-labelledby="consent">
        <h2 id="consent" className="pb-4 text-2xl text-buff-400">Consent</h2>
